    ...
    <footer className="footer premiumFooter">
      <div className="footerInner premiumFooterInner">
        <div>
          ...
          <div className="socialLinks socialLinksRich footerSocialDesktop">
            <a href={INSTAGRAM_URL} target="_blank" rel="noreferrer" className="socialChip" aria-label="Instagram">
              <span className="socialSvg"><SocialIcon type="instagram" /></span>
              <span>Instagram</span>
            </a>
            <a href={FACEBOOK_URL} target="_blank" rel="noreferrer" className="socialChip" aria-label="Facebook">
        ...
        <div>
          ...
          <p>Rafael Alexandrowitch<br />(11) 97400-5163</p>
          <p>{CONTACT_EMAIL}</p>
          <p>{MARIA_EMAIL}</p>
