      ...
      <form className="smartEditorForm" onSubmit={handleSubmit}>
          ...
          <div className="editorGrid">
            ...
            <label className="editorField">
              ...
              <input
                ...
                value={draft.condominium_fee}
                onChange={(event) => updateDraft("condominium_fee", event.target.value)}
                placeholder="R$ 850 / mês"
              />
            </label>
            ...
            <label className="editorField">
              ...
              <input
                name="iptu"
                value={draft.iptu}
                onChange={(event) => updateDraft("iptu", event.target.value)}
                placeholder="R$ 320 / mês"
              />
            </label>
          </div>
        </section>
        ...
        <section className="editorSection">
          ...
          <div className="editorGrid">
            ...
            <label className="editorField">
              <span>Mobiliado</span>
              <select name="furnished" value={draft.furnished} onChange={(event) => updateDraft("furnished", event.target.value)}>
