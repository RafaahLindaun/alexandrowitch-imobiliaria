        ...
        <section className="editorSection">
          <div className="editorSectionTitle">
            ...
            <div>
              ...
              <p>Usados na busca e na página do imóvel.</p>
            </div>
          </div>
        ...
        <section className="editorSection">
          <div className="editorSectionTitle">
            ...
            <div>
              ...
              <p>Escolha a foto que será a capa do anúncio.</p>
            </div>
          </div>
          ...
          <div className="coverManager">
            ...
            <div className="coverThumbArea">
              ...
              <label className="editorUploadBox">
                ...
                <span>Envie novas fotos e toque na que será a capa.</span>
                <input
                  name="images"
                  type="file"
                  accept="image/*"
        ...
        <section className="editorSection">
          <div className="editorSectionTitle">
            ...
            <div>
              ...
              <p>Descrição e contato do anúncio.</p>
            </div>
          </div>
          ...
          <label className="editorUploadBox">
            ...
            <span>Opcional. Adicione plantas do imóvel.</span>
