    ...
    >
      ...
      <div className="airbnbCardBody">
        ...
        <p className="airbnbSpecs">
          ...
          {property.parking ? ` • ${property.parking} vagas` : ""}{property.furnished === "Sim" ? " • Mobiliado" : ""}
        </p>
        ...
        {(property.condominium_fee || property.iptu) && (
          <div className="airbnbCardCosts">
            {property.condominium_fee && <span>Condomínio {property.condominium_fee}</span>}
            {property.iptu && <span>IPTU {property.iptu}</span>}
          </div>
        )}
