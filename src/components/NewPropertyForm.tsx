...
export default function NewPropertyForm() {
  ...
  const [draft, setDraft] = useState({
    ...
    parking: "0",
    description: "",
    broker_name: "Rafael Alexandrowitch",
      ...
      <form className="smartEditorForm" onSubmit={handleSubmit}>
        <div className="editorStatusBar">
          <div>
            ...
            <p>Preencha e acompanhe a prévia. A primeira foto vira capa.</p>
          </div>
        </div>
        ...
        <section className="editorSection">
          <div className="editorSectionTitle">
            ...
            <div>
              ...
              <p>Campos principais do anúncio.</p>
            </div>
          </div>
        ...
        <section className="editorSection">
          <div className="editorSectionTitle">
            ...
            <div>
              <h3>Fotos e capa</h3>
              <p>Escolha as fotos e defina a capa.</p>
            </div>
          </div>

          <label className="editorUploadBox">
            <strong>Fotos do imóvel</strong>
            <span>Envie várias fotos e toque na capa desejada.</span>
