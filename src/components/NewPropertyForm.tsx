      ...
      <form className="smartEditorForm" onSubmit={handleSubmit}>
        ...
        <section className="editorSection">
          ...
          <div className="editorGrid">
            ...
            <label className="editorField"><span>Condomínio</span><input name="condominium_fee" value={draft.condominium_fee} onChange={(event) => updateDraft("condominium_fee", event.target.value)} placeholder="R$ 850 / mês" /></label>
            <label className="editorField"><span>IPTU</span><input name="iptu" value={draft.iptu} onChange={(event) => updateDraft("iptu", event.target.value)} placeholder="R$ 320 / mês" /></label>
          </div>
        </section>
