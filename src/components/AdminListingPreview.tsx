    ...
    <aside className="editorPreviewCard">
      ...
      <div className="previewBody">
        ...
        <div className="previewMeta">
          {data.operation || "Venda"} • {data.category || "Tipo do imóvel"}{data.furnished ? ` • ${data.furnished === "Sim" ? "Mobiliado" : "Não mobiliado"}` : ""}
        </div>

        {(data.condominium_fee || data.iptu) && (
          <div className="previewCosts">
            {data.condominium_fee && <span>Condomínio {data.condominium_fee}</span>}
            {data.iptu && <span>IPTU {data.iptu}</span>}
          </div>
        )}
        ...
        <div className="previewMetrics">
          ...
          {data.furnished && <div><strong>{data.furnished}</strong><span>Mobiliado</span></div>}
        </div>
        ...
        <div className="previewBroker">
          ...
          <div>
            <strong>{data.broker_name || "Rafael Alexandrowitch"}</strong>
