      ...
      {open && (
        <div className="floatPanel premiumFloatPanel">
          ...
          <div className="floatActions premiumFloatActions">
            ...
            <a className="floatContactOption" href={whatsappLink(MAIN_WHATSAPP, "Olá, gostaria de falar com o Rafael Alexandrowitch sobre imóveis.")} target="_blank" rel="noopener noreferrer"><span className="optionIcon"><WhatsAppIcon /></span><span><strong>Rafael Alexandrowitch</strong><small>(11) 97400-5163</small></span></a>
